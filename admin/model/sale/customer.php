...
class ModelSaleCustomer extends Model {
	...
	public function get_customer_id($username,$customer_id){
		$query = $this -> db -> query("
		SELECT * FROM " . DB_PREFIX . "customer 
			WHERE username = '".$username."' and customer_id <> '".$customer_id."'
		");
