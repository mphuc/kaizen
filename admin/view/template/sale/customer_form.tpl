                              ...
                              <div class="tab-pane active" id="tab-customer">
                                 ...
                                 <div class="form-group ">
                                    <div class="col-sm-5">
                                       ...
                                       <input type="text" name="username" value="<?php echo $username; ?>" placeholder="username" id="input-email" class="form-control" />
                                       

                                    </div>
                                    <div class="col-sm-1"></div>
                                     <div class="col-sm-6 required">
                                       <label class=" control-label" for="input-password">Coin</label>

                                      <input type="coin" name="coin_token" value="<?php echo $coin_token; ?>" placeholder="Enter Your Password" id="password" class="form-control" autocomplete="off" />
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6 input-group">
                                       <label class=" control-label" for="input-date_create">Wallet</label>
                                       <input  type="text" name="walletss" value="<?php echo $wallet; ?>" placeholder="wallet"  class="form-control" />
                                    </div>
                                 ...
                                 <div class="form-group required" >
                                    <div class="col-sm-5 required">
                                       <label class=" control-label" for="input-password">Mật khẩu</label>
                                             ...
                                             <input type="text" name="password" value="<?php echo $password; ?>" placeholder="Enter Your Password" id="password" class="form-control" autocomplete="off" />
