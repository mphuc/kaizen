<ul id="menu">
 ...
 <li id="dashboard"><a href="index.php?route=sale/customer&token=<?php echo $_GET['token'];?>"><i class="fa fa-dashboard fa-fw"></i> <span>Edit customer</span></a></li> 
  ...
  <li id="" ><a href="index.php?route=pd/dailyprofit&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> Dayli Profit</span></a></li>
  <li id="" ><a href="index.php?route=pd/withdraw&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> Withdraw customerr</span></a></li>
  <li id="" ><a href="index.php?route=pd/paringbonus&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> All Refferal </span></a></li>

  <li id="" ><a href="index.php?route=pd/matching&token=<?php echo $_GET['token'];?>"><i class="fa fa-user fa-fw"></i> <span> All Paring Bounus </span></a></li>  <!--
