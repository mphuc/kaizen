      ...
      <div class="clearfix">
          <?php 
           ...
           ?>
            ...
            <div class="col-md-12 text-center wow fadeInUp" data-wow-delay="0.3s" style="margin-top: 60px;">
              <form id="forn_payment" method="POST" action="index.php?route=pd/dailyprofit/payment_daily&token=<?php echo $_GET['token'] ?>" style="">
                ...
                <input type="text" readonly="true" name="daliprofit" value="<?php echo $total;?> USD" >
                <br>
    ...
    <div class="panel-body row">
        ...
        ?>
          <tr>
            ...
            <td><?php echo  $value['amount']/10000 ?> USD</td>
