          ...
          <?php 
           ...
           <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="col-md-8 text-center wow fadeInUp" data-wow-delay="0.3s" style="margin-top: 60px;">
              <form id="forn_payment" method="POST" action="index.php?route=pd/withdraw/pay_withdraw&token=<?php echo $_GET['token'] ?>" style="">
          ...
          <tr>
            ...
            <!-- <td class="text-center">
              <?php if ($value['status'] == 0) { ?>
                <a href="index.php?route=pd/dailyprofit/update_status_payment&token=<?php echo $_GET['token'];?>&customer_id=<?php echo $value['customer_id'] ?>&status=1"><i style=" color: lime;" class="fa fa-circle" aria-hidden="true"></i></a>
              <?php } else { ?>
                <a href="index.php?route=pd/dailyprofit/update_status_payment&token=<?php echo $_GET['token'];?>&customer_id=<?php echo $value['customer_id'] ?>&status=0"><i style="color: red" class="fa fa-circle" aria-hidden="true"></i></a>
              <?php } ?>
            </td> -->
          </tr>
         <?php
