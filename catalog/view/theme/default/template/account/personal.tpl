...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-xs-12">
    <h2 class="content-header-title mb-0">Downline Tree</h2>
    <div class="row breadcrumbs-top">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="home.html">Home</a>
          </li>
          <li class="breadcrumb-item"><a href="#">Downline binaryTree</a>
          </li>
...
<div class="h-main-content">
    <div class="container">
        ...
        <div id="tab-binary" class="panel panel-default">
          <div class="row" >
           ...
           <div class="">
              ...
              <span class="cir lv0" style="background: #673ab7"></span> 5 USD - 
              <span class="cir lv1"></span> 50 USD -
              <span class="cir lv2" style="background: #4CAF50"></span> 100 USD - 
               <span class="cir lv3"></span> Not Package
